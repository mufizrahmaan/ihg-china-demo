...
if (isset($_POST['yes']) && $_POST['yes'] == 'Yes' && $_POST['id'] != '') {
		...
		if($id)
		{
		echo "Deleting Advertising Agency with ID : ".$id;
		
		$sql = "DELETE FROM company_registration WHERE id = '" . $id."'";
		$result = $db->exec($sql);
...
<!-- main content starts from here -->
				...
				<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Delete Advertising Agency</li>
						</ul><!-- .breadcrumb -->
						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									&nbsp;&nbsp;&nbsp;<font color="red">(Warning! Deleting Advertising Agency will delete all the associated data for this Advertising Agency, once deleted this cant be UNDONE) </font>
								</small>
							</h1>
						</div><!-- /.page-header -->
 ...
 <?php
	...
	<fieldset>
		<label>Confirm Delete Advertising Agency <strong><?php echo isset($row[name]) ? $row[name] : ''; ?> </strong></label>
