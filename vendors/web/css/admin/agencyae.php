...
$sql = "SELECT * FROM agency_role ORDER BY role";
$stmt = $db->query($sql);
...
if ($showForm == true) {
    if (isset($_POST['Submit']) && $_POST['Submit'] == 'Submit') {
        if (trim($_POST['name']) != '' && strlen($_POST['name']) > 3)
            ...
            $error .= '<strong><i class="icon-remove"></i></strong>&nbsp;Advertiser Agency Name is a required field.<br/>';
        ...
        if (isset($_POST['id']) && !empty($_POST['id']) && $error == '') {
			$id = $_POST['id'];
				...
				else
				{
					...
					$to      = $email_id;
					$subject = 'New Advertiser Agency Added in Shelf - Login Details';
					$message = 'New Advertiser Agency Added in Shelf <br/><br/>'.'Advertiser Agency Name : '.$name.'<br/><br/>Username : '.$email_id.'<br/><br/>Password : '.$password;
					$headers = 'From: admin@mintm.com' . "\r\n" .
						'Reply-To: admin@mintm.com' . "\r\n" .
...
<!-- main content starts from here -->
				...
				<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active"><?php echo $action; ?> Advertising Agency</li>
						</ul><!-- .breadcrumb -->
					...
					<div class="page-content">
						<div class="page-header">
							<h1>
								<?php echo $action; ?> Advertising Agency
								<small>
 ...
 <?php
   ...
   <div class="form-actions">
	 ...
	 <a href="agency.php" class="btn btn-sm"><i class="icon-remove"></i> Cancel</a>
     <input type="hidden" name="id" value="<?php echo isset($_REQUEST['id']) ? (int) $_REQUEST['id'] : ''; ?>"/>
	 <br/><br/><a href="agency.php"><i class="icon-reply"></i> Back to Advertising Agency</a>
   </div>
   </div>
