...
$column[] = array(	"label" => "Report",
					...
					"colspan" => "1",
					"align" => "left",
					"href" => "engagement.php?show=overall&id=",
					"imgsrc" => "");	

$column[] = array(	"label" => "Establishments",
					"db_field" => "View Establishments",
					"db_field_type" => "text",
					//"db_table" => $data_table_name,
					"width" => "11%",
					"sortable" => "1",
					"colspan" => "1",
					"align" => "left",
					"href" => "companyEstablishmentList.php?id=",
					"imgsrc" => "");						
