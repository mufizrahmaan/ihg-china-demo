...
<?php include('header.php'); ?>
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            document.getElementById('footfall').innerHTML = jQuery.parseJSON(jsonData).footFall;			
...
<br/><br/>
									...
									<div class="col-sm-9 col-sm-offset-2 infobox-container">
										...
										<div class="infobox infobox-green">
											...
											<div class="infobox-data">
												<span class="infobox-data-number"><div id="footfall"></div></span>
												<div class="infobox-content">Foot Fall</div>
											</div>											
											<!-- <div class="badge badge-success">32%</div> -->
										</div>										
