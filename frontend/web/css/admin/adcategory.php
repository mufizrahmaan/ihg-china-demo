...
// page name
$page_name = "AD Categories";

// title bar
$page_title = "AD Categories";

// pagename
$page_file_name = "adcategory";

// data_table_name
$data_table_name = "ad_category";

// table
$table = array(	"label" => "AD Categories",
...
$column[] = array(	"label" => "AD Category",
					"db_field" => "ad_category",
					"db_field_type" => "text",
					"db_table" => $data_table_name,
					"width" => "10%",
					"sortable" => "1",
...
// query 
$query_select = "SELECT * FROM ".$data_table_name;
