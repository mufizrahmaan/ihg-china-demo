...
$column[] = array(	"label" => "Is Agency",
					"db_field" => "advertising_agency",
					"db_table" => $data_table_name,
					"db_field_type" => "cbo",
					"width" => "10%",
					"sortable" => "1",
