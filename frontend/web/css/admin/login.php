...
if(isset($data['emailId']))
{
	...
	if(mysql_num_rows($result) != 0){
		...
		$_SESSION['logo'] = $rowcompanyLogo['company_logo'];
		$_SESSION['company_name'] = "Super Admin";
//		header("Location:PulseAnalytics_access.php");
...
<html lang="en">
	...
	<!--<body  style="background: url(images/bg.jpg) no-repeat fixed; background-size: cover;" class="login-layout"> -->
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<img width="80px" src="images/mintm.png">
									<span class="green">Shelf</span>
									<span class="white">Super Admin</span>
								</h1>
								<h4 class="blue">&copy; MintM</h4>
							</div>
												...
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" class="form-control" placeholder="Email" id="emailId" name="emailId"/>
															<i class="icon-user"></i>
														</span>
													</label>
